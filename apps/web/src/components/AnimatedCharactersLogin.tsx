...
import { Eye, EyeOff, Github, Sparkles, User } from 'lucide-react';
...
function LoginPage() {
  ...
  }, [location.pathname, navigate, form]);
  ...
  useEffect(() => {
    ...
    if (password && password.length > 0 && showPassword) {
      const schedulePeek = () => {
  ...
  }, [form.watch('password'), showPassword, isPurplePeeking]);
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            <div
              ...
              style={{
                ...
                height:
                  isTyping ||
                  (form.watch('password') && form.watch('password').length > 0 && !showPassword)
                    ? '440px'
                    : '400px',
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">请输入您的详细信息</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-500">账号</FormLabel>
                    <FormControl>
                      <InputGroup>
                        <InputGroupInput
                          placeholder="请输入用户名"
          ...
          <div className="mt-6">
            <Button
              variant="outline"
              className="w-full bg-background border-border/60 hover:bg-accent"
              type="button"
            >
              <Github className="mr-1 size-4.5" />
              使用 Github 登录
            </Button>
          </div>
